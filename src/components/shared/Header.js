  ...
  <>
    ...
    >
      ...
      <div style={{
        ...
        {isLoggedIn ? (
          <Link to="/settings" className="fj-header-link" style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <Link to="/login" className="fj-header-link" style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
