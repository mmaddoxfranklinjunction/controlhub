...
const SidebarLayout = () => {
  ...
  return (
    <div className="flex h-screen">
      <aside className="w-56 bg-[#253847] text-white p-4 space-y-1 overflow-y-scroll scrollbar-thin scrollbar-track-gray-700 scrollbar-thumb-gray-500 flex flex-col">
        <HostDropdown />
        ...
        <nav className="flex-1 space-y-1">
          ...
          >
            <Icon>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                  d="M3 3v18h18M9 17V9m6 8v-6m-6 6v-2"
                />
              </svg>
            </Icon>
          ...
          >
            <Icon>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                />
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                  d="M19.4 15a1.65 1.65 0 00.33 1.82l.06.06a2 2 0 11-2.82 2.82l-.06-.06a1.65 1.65 0 00-1.82-.33h0a1.65 1.65 0 00-1 .47l-.09.09a2 2 0 11-2.83-2.83l.09-.09a1.65 1.65 0 00.47-1 1.65 1.65 0 00-.33-1.82l-.06-.06a2 2 0 112.82-2.82l.06.06a1.65 1.65 0 001.82.33h0a1.65 1.65 0 001-.47l.09-.09a2 2 0 012.83 2.83l-.09.09a1.65 1.65 0 00-.47 1z"
                />
              </svg>
            </Icon>
