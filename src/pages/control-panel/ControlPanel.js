      ...
      <div className="px-4 py-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-4 flex flex-col justify-between h-64">
            <h2 className="text-base font-semibold text-[#253847] font-sans mb-1">Marketing</h2>
          ...
          {/* Operations Card */}
          <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-4 flex flex-col justify-between h-64">
            <h2 className="text-base font-semibold text-[#253847] font-sans mb-1">Operations</h2>
          ...
          {/* Locations Card */}
          <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-4 flex flex-col justify-between h-64">
            <h2 className="text-base font-semibold text-[#253847] font-sans mb-1">Locations</h2>
          ...
          {/* Menu Card */}
          <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-4 flex flex-col justify-between h-64">
            <h2 className="text-base font-semibold text-[#253847] font-sans mb-1">Menu</h2>
            <div className="text-center text-[#5C6B7A] text-sm">Metrics coming soon...</div>
            <div className="flex justify-between text-sm text-[#B3282D] font-medium mt-auto">
